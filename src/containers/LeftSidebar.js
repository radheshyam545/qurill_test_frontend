      ...
      <div className="drawer-side  z-30 ">
        ...
        <ul className="menu px-[20px] pr-[40px] py-[26px]  lg:w-[252px] w-[300px] bg-base-100 min-h-full   text-base-content">
          ...
          <li className="mb-[70px] font-semibold text-xl">
            <Link
              className="lg:justify-center lg:px-0 px-4 site-logo p-0"
              to={"/seeker/dashboard"}
            >
              <span className="rounded-[10px] w-10 bg-primary h-10"></span>Qruil
            </Link>{" "}
          </li>
          {routes.map((route, k) => {
            return (
              <li className="menu-link bg-[#FFFFFF]" key={k}>
                {route.submenu ? (
                  ...
                  >
                    <span
                      className={`h-[100%] rounded-[10px] bg-[#FFCB05] text-[black] sidebar-button-icon-p-m`}
                    >
                      {route.icon}
                    </span>
                    <span
                      className={`se font-semibold text-[15px] text-[black]`}
                    >
                      {route.name}
                    </span>
                  </button>
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      ` ${
                        isActive
                          ? "bg-[#FFCB05] focus:border-[] focus:bg-[#FFCB05]  rounded-[12px] sidebar-button-p-m   "
                          : " sidebar-button-p-m font-normal hover:bg-[#FFF7EA]"
                      }`
                    }
                  >
                    <span
                      className={` h-[100%] rounded-[10px] ${
                        location.pathname === route.path
                          ? "bg-[black] text-[#FFCB05] sidebar-button-icon-p-m"
                          : "bg-[#FFCB05] text-[black] sidebar-button-icon-p-m"
                      }`}
                    >
                      {route.icon}
                    </span>
