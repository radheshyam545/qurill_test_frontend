...
function JobPostOverlayState({ heading, tab, setTab, postJobData, setPostJobData, name = "", countryDataForWorkPage, setCountryDataForWorkPage }) {
          ...
          <form onSubmit={handleSubmit}>
            <div className='grid grid-cols-1 -mt-[35px] mx-[20px] mb-[65px]'>
              ...
              <Select
                ...
                isSearchable
                placeholder="Select"
                value={USStates.find((item) => item?.label === formData?.state) || null}
...
export default JobPostOverlayState
