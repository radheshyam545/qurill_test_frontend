...
function JobPostOverlayCountry({ heading,setTab, postJobData, setPostJobData, name = ""}) {
          ...
          <form onSubmit={handleSubmit}>
            <div className='grid grid-cols-1 -mt-[35px] mx-[20px] mb-[65px]'>
              ...
              <Select
                ...
                isSearchable
                placeholder="Select"
                // value={countryDataForWorkPage.find((item) => item.value === formData.country) || null}
                value={CountryDATA.find((item) => item.value === formData.country) || null}
...
export default JobPostOverlayCountry
