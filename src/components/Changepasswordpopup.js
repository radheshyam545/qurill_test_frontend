...
function Changepasswordpopup({onClose}) {
  return (
    ...
    <div className='change-password-innerdiv w-[425px] p-5 bg-white rounded-xl absolute z-[7] shadow-2xl '>
      
     
       <h2 className='text-2xl text-[18px] font-semibold w-full pb-5'>
         Change password
       </h2>

       <label className='text-[15px] font-semibold block w-full pb-1'>
       Current password
       </label>
       ...
       <label className='text-[15px] text font-semibold block w-full pb-1 pt-2'>
       New password
       </label>
     ...
     <div className='flex w-full p-6'>
       <button className='w-[80px] text-[15px] h-[40px] bg-[#FFCB05] rounded-xl'>
         save
       </button>
       <button onClick={onClose} className='w-[80px] text-[15px] h-[40px] bg-[#F4F8FB] ml-8 rounded-xl'>
         cancel
       </button>
     </div>
